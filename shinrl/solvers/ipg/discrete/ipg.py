...
class IpgSolver(Solver):
    def run(self, num_steps=10000):
        for _ in tqdm(range(num_steps)):
            ...
            tensor_off_traj = utils.trajectory_to_tensor(
                off_trajectory, self.device)
    ...
    def compute_coef(self, traj):
        ...
        next_values = self.baseline_network(
    ...
    def update_actor(self, tensor_traj, tensor_off_traj):
        ...
        off_loss = -self.solve_options["on_off_coef"] * \
            ((values * off_policy).sum(1)).mean()
