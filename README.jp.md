...
このライブラリは[diag_q](https://github.com/justinjfu/diagnosing_qlearning)を基に, より使いやすさを重視して開発しています (そのため基本的な設計理念は[Diagnosing Bottlenecks in Deep Q-learning Algorithms](https://arxiv.org/abs/1902.10250)と同じです).
...
また, 初期化時にtrainsのloggerを渡すことで[trains](https://github.com/allegroai/trains)による学習の確認もできますが, 渡さなくても実行は可能です ([examples/scripts/solve_pendulum.py](examples/scripts/solve_pendulum.py)参照).
